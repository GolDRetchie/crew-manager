...
(function () {
  ...
  function injectCss(){
    ...
    css.textContent = [
      ...
      ".cmtb-emblem{width:48px;height:48px;flex:0 0 auto;border-radius:12px;color:#fff;font-family:var(--display);font-size:24px;display:flex;align-items:center;justify-content:center;border:2px solid var(--gold-d);box-shadow:inset 0 -4px 0 rgba(0,0,0,.22);overflow:hidden;}",
      ...
      ".cmtb-pop-av{width:34px;height:34px;flex:0 0 auto;border-radius:50%;color:#fff;display:flex;align-items:center;justify-content:center;font-family:var(--display);font-size:16px;box-shadow:inset 0 -2px 0 rgba(0,0,0,.22);overflow:hidden;}",
